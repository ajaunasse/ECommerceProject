 ...
 * @ORM\Entity(repositoryClass="Users\UsersBundle\Repository\UserAdressRepository")
 */
class UserAdress
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Users\UsersBundle\Entity\Users", inversedBy="adress")
